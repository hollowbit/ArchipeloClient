...
public class WebSockets {
     ...
     *  @return {@link WebSocket} instance allowing to connect with the passed URL with the passed SSL certification credentials.
     *  @see #toWebSocketUrl(String, int) */
    public static WebSocket newSecureSocket(final String url, final Files gdxFiles, final String keystorePath, final String storeType, final String keyPass, final String storePass) {
    	if (FACTORY == null) {
            throw new WebSocketException("Web sockets are not initiated.");
        }
        return FACTORY.newSecureWebSocket(url, gdxFiles, keystorePath, storeType, keyPass, storePass);
    }
    ...
    protected static interface WebSocketFactory {
        ...
        /** @param url URL to connect with. Factory can assume that the URL is not null and valid.
         *  @param gdxFiles Simply pass 'Gdx.files'
         *  @param keystorePath Path to the self-signed keystore
         *  @param storeType Type of keystore (Usually "JKS")
         *  @param keyPass Password for keystore
         *  @param storePass Password for store
         * @return platform-specific {@link WebSocket} instance. */
        WebSocket newSecureWebSocket(String url, Files gdxFile, String keystorePath, String storeType, String keyPass, String storePass);
    }
}
